...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-markdown_inline/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-markdown_inline/actions/workflows/validate.yml)

Neovim tree-sitter queries for **markdown_inline**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-markdown_inline",
...
- [ ] Changes are scoped to `markdown_inline` — do not include files for other languages
